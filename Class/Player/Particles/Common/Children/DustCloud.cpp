...
DustCloud::DustCloud(Player* player, FollowCamera* followCamera, const std::string& texName) {
	player_ = player;
...
void DustCloud::Create(const LWP::Math::Vector3& pos) {
	...
	plane_.material.texture = LWP::Resource::LoadTexture("Effect/Particle.png");
