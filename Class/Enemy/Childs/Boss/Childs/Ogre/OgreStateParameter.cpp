...
void OgreState::ParameterConfig::InitJson()
{
	...
	json.BeginGroup("OgreParameter")
		...
		.EndGroup()
		.BeginGroup("Dead")
		.AddValue<float>("StepBackSpeed", &stateParameter_.deadParameter.stepBackSpeed)
		.AddValue<float>("BackStartFirst", &stateParameter_.deadParameter.backStartF)
		.AddValue<float>("BackEndFirst", &stateParameter_.deadParameter.backEndF)
		.AddValue<float>("BackStartSecond", &stateParameter_.deadParameter.backStartS)
		.AddValue<float>("BackEndSecond", &stateParameter_.deadParameter.backEndS)
		.EndGroup()
		.EndGroup()
		.CheckJsonFile();
